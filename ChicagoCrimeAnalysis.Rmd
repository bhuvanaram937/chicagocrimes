---
title: "Visualization of Chicago Crime Data"
output:
  html_document:
    df_print: paged
    toc: yes
...
```{r dev.args=list(pointsize=18), echo = TRUE}  
...
* Crime incidences were higher in July and August 
* Crime incidences were higher between noon to midnight of each day
* Theft is a common crime in Chicago
* District 8 and 11 have the highest crime rates
* Austin has high crime rate compared to other communities in Chicago
* Most crimes occur on streets and houses
* There are far fewer arrests than crimes
* We can predict the number of future crimes with an accuracy of ~98%
